...
<head>
    ...
    if ($ready) {
        echo("Paramètres avancés - Administration du site - " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename"));
    } else {
...
<body>
    ...
    </div><div id="navigation"><a href="/cms-special/admin/home" class="sblink">Administration</a> &gt; <a href="/cms-special/admin/housekeeping" class="sblink">Maintenance</a></div>
        <h2>Paramètres avancés de votre site</h2>
        <ul>
            <li>
