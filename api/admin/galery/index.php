...
if (isset($_COOKIE['ADMIN_TOKEN'])) {
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/tokens/" . $_COOKIE['ADMIN_TOKEN'])) {
        ...
        die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/galery&pa='</script>");
    }
} else {
    die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/galery&pa='</script>");
}
...
<head>
    ...
    if ($ready) {
        echo("Galerie de photos - Administration du site - " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename"));
    } else {
...
<body>
    ...
    <div id="banner" style='background-image: url("<?= $banner ?>");'>
        ...
        <p><table class="message_info"><tbody><tr><td><img src="/resources/image/message_info.svg" class="message_img"></td><td style="width:100%;"><p>Si vous activez la galerie de photos, une page supplémentaire ("Galerie de photos") sera ajoutée à votre site. Vous ne pourrez pas la modifier librement, et les photos seront organisées par catégorie.</p><p>Si vous n'activez pas la galerie de photos, les images seront accessibles uniquement à partir de leur identifiant.</p></td></tr></tbody></table></p>
