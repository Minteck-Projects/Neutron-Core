...
if (isset($_POST['page'])) {
    ...
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent")) {
        if (isset($_POST['newname'])) {
            ...
            if ($newslug == "api" || $newslug == "cms-special" || $newslug == "vendor" || $newslug == "cms-unrelated" || $newslug == "data" || $newslug == "resources" || $newslug == "widgets" || $newslug == "-htaccess" || $newslug == "index" || $newslug == "index-php") {
