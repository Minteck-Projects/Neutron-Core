...
if (isset($_COOKIE['ADMIN_TOKEN'])) {
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/tokens/" . $_COOKIE['ADMIN_TOKEN'])) {
        ...
        die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/housekeeping/reset&pa='</script>");
    }
} else {
    die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/housekeeping/reset&pa='</script>");
}
...
<head>
    ...
    if ($ready) {
        echo("Réinitialiser votre site - Maintenance - Administration du site - " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename"));
    } else {
