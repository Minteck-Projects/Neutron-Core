...
const EasyCSS = {
    ...
    css: function (config) {
        ...
        this.append("<select class=\"easycss-input-selector\" id=\"" + this.instance + "-source\"><option value=\"null\" selected disabled> - " + this.lang.select.element + " - </option>");
