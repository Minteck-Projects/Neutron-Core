...
<head>
    ...
    if ($ready) {
        ...
        echo("Affichage connecté - Neutron");
    }
...
<body>
    ...
    <div id="banner" style='background-image: url("<?= $banner ?>");'>
        <center><table style="width:100%;"><tr><td style="width:50%;"><img style="float:right;" id="banner-logo" src="/resources/upload/siteicon.png"><td><td><span style="float:left;" id="adminb" <?php if ($blackBannerText) {echo("class=\"banner-black\"");} ?>><span id="banner-name" <?php if ($blackBannerText) {echo("class=\"banner-black\"");} ?>><?= file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename") ?><br></span>Neutron <?= str_replace("#", substr(md5(file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/api/version")), 0, 2), file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/api/version")) ?> • <?= $sizestr ?></span></td></tr></table></center>
        ...
        <center>
            <p><span class="step">①</span> Installez l'application <b>Neutron Display</b> sur votre smartphone Android</p>
            ...
            <p><span class="step">③</span> Lancez l'application <b>Neutron Display</b> et suivez les instructions affichées sur l'affichage connecté</p>
        </center>
    </div>
</body>
</html>