...
buffer("<p>" . $lang["version"]["workswith"] . "<b><a href=\"http://mpcms.rf.gd\" target=\"_blank\">Minteck Projects CMS</a> version " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/api/version") . "</b>" . $lang["version"]["providedby"] . "<a href=\"https://minteck-projects.alwaysdata.net\" target=\"_blank\">Minteck Projects</a>" . $lang["version"]["description"] . "</p>");
...
buffer("<ul><li><a href=\"https://gitlab.com/minteck-projects/mpcms/code-base/issues\" target=\"_blank\">" . $lang["version"]["support"] . "</a></li>");
buffer("<li><a href=\"https://gitlab.com/minteck-projects/mpcms/plugins/issues\" target=\"_blank\">" . $lang["version"]["storesupport"] . "</a></li>");
