<header id="header-desktop" class="mdc-top-app-bar">
    <div class="mdc-top-app-bar__row">
        ...
        <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end" role="toolbar">
            <a title="<?= $lang["admin-home"]["language"] ?> — Change website language" href="/cms-special/admin/language" class="material-icons mdc-top-app-bar__navigation-icon mdc-icon-button">translate</a>
        </section>
    </div>
</header>
