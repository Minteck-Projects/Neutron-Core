...
?>
        ...
        <ul>
            ...
            <li><a class="sblink" href="/cms-special/admin/gallery/addcategory">Créer une nouvelle catégorie</a></li>
        </ul>
        ...
        if ($count == 0) {
            echo("<i>" . $lang["admin-gallery"]["pictures"]->none . "</i><p><a class=\"sblink\" href=\"/cms-special/admin/gallery/publish\">" . $lang["admin-gallery"]["pictures"]->add . "</a></p>");
        } else {
            foreach ($dirs as $el) {
                if ($el == "." || $el == "..") {} else {
            ...
            echo("<b><a class=\"sblink\" href=\"/cms-special/admin/gallery/publish\">" . $lang["admin-gallery"]["pictures"]->add . "</a></b>");
        }
