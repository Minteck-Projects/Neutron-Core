...
if (isset($_COOKIE['ADMIN_TOKEN'])) {
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/tokens/" . $_COOKIE['ADMIN_TOKEN'])) {
        ...
        die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/galery/publish&pa='</script>");
    }
} else {
    die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/galery/publish&pa='</script>");
}
...
<head>
    ...
    if ($ready) {
        echo("Ajouter une nouvelle photo - Galerie de photos - Administration du site - " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename"));
    } else {
...
<body>
    ...
    </div><div id="navigation"><a href="/cms-special/admin/home" class="sblink">Administration</a> &gt; <a href="/cms-special/admin/galery" class="sblink">Galerie de photos</a> &gt; <a href="/cms-special/admin/galery/publish" class="sblink">Ajouter une photo</a></div>
