...
if (isset($_COOKIE['ADMIN_TOKEN'])) {
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/tokens/" . $_COOKIE['ADMIN_TOKEN'])) {
        ...
        if (isset($_GET['slug'])) {
            die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/pages/delete/&pa=?slug=" . $_GET['slug'] . "'</script>");
        } else {
            die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/pages/delete&pa='</script>");
        }
    }
} else {
    if (isset($_GET['slug'])) {
...
<head>
    ...
    if ($ready) {
        echo("Suppression de {$currentName} - Pages - Administration du site - " . file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/data/webcontent/sitename"));
    } else {
