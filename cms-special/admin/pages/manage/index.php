...
if (isset($_COOKIE['ADMIN_TOKEN'])) {
    if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/data/tokens/" . $_COOKIE['ADMIN_TOKEN'])) {
        ...
        if (isset($_GET['slug'])) {
            die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/pages/manage/&pa=?slug=" . $_GET['slug'] . "'</script>");
        } else {
            die("<script>location.href = '/cms-special/admin/?pr=/cms-special/admin/pages/manage&pa='</script>");
        }
    }
} else {
    if (isset($_GET['slug'])) {
