<?php $pageConfig = [ "domName" => "Nouvelle page - Pages", "headerName" => "Nouvelle page" ]; require_once $_SERVER['DOCUMENT_ROOT'] . "/cms-special/admin/\$resources/precontent.php"; ?>
            <p>
                <form name="settings">
                    <center><input id="name" type="text" placeholder="<?= $lang["admin-pages-old"]["pagename"] ?>"></center><br>
                    <input type="radio" id="type-visual" value="visual" onchange="switchEditor()" name="type" checked>
                    <label for="type-visual"><?= $lang["admin-pages-old"]["classic2"] ?></label><br>
                    <input type="radio" id="type" onchange="switchEditor()" value="html" name="type">
                    <label for="type-html"><?= $lang["admin-pages-old"]["html2"][0] ?> <i><?= $lang["admin-pages-old"]["html2"][1] ?></i></label>
                </form>
            </p>
            <div id="editing"><?= $lang["admin-pages-old"]["content"] ?><div id="editor-visual">
                <?php
